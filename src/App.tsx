...
function MealPanel() { return <section className="panel meal-panel"><div className="panel-header"><div><p className="eyebrow">I dag</p><h2>Madplan</h2></div><CookingPot size={30} className="meal-icon" /></div><div className="empty-widget"><CookingPot size={26} /><p>Ingen madplan er tilknyttet endnu</p><small>Tilføj en ICS-kilde under Administration</small></div></section> }
